...
# --- THEME COLORS ---
# Moved up so navigation buttons can use these colors
soft_blue = "#AEC6CF" 
...
with nav3:
    if st.button("Vision", use_container_width=True, key="nav_vision"):
...
# Define colors based on the current theme choice
