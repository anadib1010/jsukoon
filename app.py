...
st.markdown(f"<div style='font-size:10px; opacity:0.9; letter-spacing:2px; margin-top: -8px; margin-bottom: 35px; text-transform: uppercase;'>A space built to return your attention to you, not take it from you.</div>", unsafe_allow_html=True)
